                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div className="img-container">
                                <img class="u-img-fluid" src={this.props.data.imgsrc} alt="image"/>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="pd-detail">
                                <div>
                                    <span class="pd-detail__name">{this.props.data.name}</span></div>
                                <div>
                                ...
                                <div class="u-s-m-b-15">
                                    <div class="pd-detail__inline">
                                        <span class="pd-detail__click-wrap"><i class="far fa-heart u-s-m-r-6"></i>
                                            <a onClick={this.props.addToWishlist}>Add to Wishlist</a>
                                        </span>
                                    </div>
                                </div>
                                <div class="u-s-m-b-15">
